...
struct funcionario {
    ...
    String nome; // inicial do nome do funcionario
...
int main(void)
{
    ...
    printf("Posição no array de funcionarios: %d\n", pos_func_proc);
...
Funcionario* registra_funcionarios(int qtd_funcionarios)
{
    ...
    {
        funcionarios[i].nome = le_string(&lixo, "Digite o nome do funcionario:");
        printf("Digite a matricula do funcionario %s, a matricula de seu superior (111 222): ", funcionarios[i].nome);
        scanf("%d %d", &funcionarios[i].mat, &funcionarios[i].sup);
    }
